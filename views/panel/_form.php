...
<div class="slide-composer-form">
    ...
    $forms = [
        [
            'label' => '<i class="glyphicon glyphicon-book"></i> ' . Html::encode(Yii::t('atslider', 'SlideComposerSlide')),
            'content' => $this->render('_formSlideComposerSlide', [
                'row' => \yii\helpers\ArrayHelper::toArray($model->slideComposerSlides),
            ]),
        ],
    ];
